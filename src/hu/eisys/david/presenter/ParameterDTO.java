...
public class ParameterDTO {
	...
	public ParameterDTO(final Object primaryParameter, final Object... secondaryParameters) {
		super();
	...
	public <T extends Object> T getSecondaryParameter(final int index, final Class<T> clazz) {
		T parameter = null;
	...
	public <T extends Object> List<T> getSecondaryParametersList(final Class<T> clazz) {
